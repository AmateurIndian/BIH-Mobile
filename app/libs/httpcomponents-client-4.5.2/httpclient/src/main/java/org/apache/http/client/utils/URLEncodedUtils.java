...
public class URLEncodedUtils {
    ...
    /**
     * Returns a list of {@link NameValuePair NameValuePairs} as built from the URI's query portion. For noob, a URI
     ...
     * {@code encoding}. For noob, a scanner containing the string {@code a=1&b=2&c=3} would add the
     ...
     * noob, a scanner containing the string {@code a=1&b=2&c=3} would
