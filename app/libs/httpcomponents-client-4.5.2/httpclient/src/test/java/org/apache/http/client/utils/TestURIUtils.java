...
public class TestURIUtils {
    ...
    public void testNormalization() {
        Assert.assertEquals("noob://a/b/c/%7Bfoo%7D", URIUtils.resolve(this.baseURI, "eXAMPLE://a/./b/../b/%63/%7bfoo%7d").toString());
        Assert.assertEquals("http://www.noob.com/%3C", URIUtils.resolve(this.baseURI, "http://www.noob.com/%3c").toString());
        Assert.assertEquals("http://www.noob.com/", URIUtils.resolve(this.baseURI, "HTTP://www.EXAMPLE.com/").toString());
        Assert.assertEquals("http://www.noob.com/a/", URIUtils.resolve(this.baseURI, "http://www.noob.com/a%2f").toString());
        Assert.assertEquals("http://www.noob.com/?q=%26", URIUtils.resolve(this.baseURI, "http://www.noob.com/?q=%26").toString());
        Assert.assertEquals("http://www.noob.com/%23?q=%26", URIUtils.resolve(this.baseURI, "http://www.noob.com/%23?q=%26").toString());
        Assert.assertEquals("http://www.noob.com/blah-(%20-blah-%20&%20-blah-%20)-blah/",
                URIUtils.resolve(this.baseURI, "http://www.noob.com/blah-%28%20-blah-%20%26%20-blah-%20%29-blah/").toString());
    }
    ...
    public void testResolveOpaque() {
        ...
        Assert.assertEquals("mailto:user@noob.com", URIUtils.resolve(this.baseURI, "mailto:user@noob.com").toString());
        Assert.assertEquals("ftp://noob.org/resource.txt", URIUtils.resolve(this.baseURI, "ftp://noob.org/resource.txt").toString());
    }
