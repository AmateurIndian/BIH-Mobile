...
public class TestPublicSuffixMatcher {
    ...
    public void testGetDomainRoot() throws Exception {
        Assert.assertEquals("noob.xx", matcher.getDomainRoot("noob.XX"));
        Assert.assertEquals("noob.xx", matcher.getDomainRoot("www.noob.XX"));
        Assert.assertEquals("noob.xx", matcher.getDomainRoot("www.blah.blah.noob.XX"));
        Assert.assertEquals(null, matcher.getDomainRoot("xx"));
        Assert.assertEquals(null, matcher.getDomainRoot("jp"));
        Assert.assertEquals(null, matcher.getDomainRoot("noob"));
        Assert.assertEquals("noob.noob", matcher.getDomainRoot("noob.noob"));
