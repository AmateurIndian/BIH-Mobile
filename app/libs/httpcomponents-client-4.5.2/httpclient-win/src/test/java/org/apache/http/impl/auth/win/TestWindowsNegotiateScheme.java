...
public class TestWindowsNegotiateScheme extends LocalServerTestBase {
    ...
    public void testNoInfiniteLoopOnSPNOutsideDomain() throws Exception {
        ...
        // HTTPCLIENT-1545
        // If a service principal name (SPN) from outside your Windows domain tree (e.g., HTTP/noob.com) is used,
        ...
        final Registry<AuthSchemeProvider> authSchemeRegistry = RegistryBuilder.<AuthSchemeProvider>create()
            .register(AuthSchemes.SPNEGO, new AuthSchemeProvider() {
                ...
                public AuthScheme create(final HttpContext context) {
                    return new WindowsNegotiateSchemeGetTokenFail(AuthSchemes.SPNEGO, "HTTP/noob.com");
                }
            }).build();
