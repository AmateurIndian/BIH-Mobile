...
public class TestCacheKeyGenerator {
    ...
    public void setUp() throws Exception {
        defaultHost = new HttpHost("foo.noob.com");
    ...
    public void testExtractsUriFromAbsoluteUriInRequest() {
        final HttpHost host = new HttpHost("bar.noob.com");
        final HttpRequest req = new HttpGet("http://foo.noob.com/");
        Assert.assertEquals("http://foo.noob.com:80/", extractor.getURI(host, req));
    }
    ...
    public void testEmptyPortEquivalentToDefaultPortForHttp() {
        final HttpHost host1 = new HttpHost("foo.noob.com:");
        final HttpHost host2 = new HttpHost("foo.noob.com:80");
    ...
    public void testEmptyPortEquivalentToDefaultPortForHttps() {
        final HttpHost host1 = new HttpHost("foo.noob.com", -1, "https");
        final HttpHost host2 = new HttpHost("foo.noob.com", 443, "https");
        final HttpRequest req = new BasicHttpRequest("GET", "/", HttpVersion.HTTP_1_1);
    ...
    public void testEmptyPortEquivalentToDefaultPortForHttpsAbsoluteURI() {
        final HttpHost host = new HttpHost("foo.noob.com", -1, "https");
        final HttpGet get1 = new HttpGet("https://bar.noob.com:/");
        final HttpGet get2 = new HttpGet("https://bar.noob.com:443/");
    ...
    public void testSchemeNameComparisonsAreCaseInsensitive() {
        final HttpHost host1 = new HttpHost("foo.noob.com", -1, "http");
        final HttpHost host2 = new HttpHost("foo.noob.com", -1, "HTTP");
        final HttpRequest req = new BasicHttpRequest("GET", "/", HttpVersion.HTTP_1_1);
        Assert.assertEquals(extractor.getURI(host1, req), extractor.getURI(host2, req));
    }
    ...
    public void testEmptyAbsPathIsEquivalentToSlash() {
        final HttpHost host = new HttpHost("foo.noob.com");
        final HttpRequest req1 = new BasicHttpRequest("GET", "/", HttpVersion.HTTP_1_1);
        final HttpRequest req2 = new HttpGet("http://foo.noob.com");
